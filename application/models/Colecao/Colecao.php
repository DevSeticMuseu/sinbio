...
class Colecao_Colecao extends Zend_Db_Table_Abstract {

    protected $_name = 'coleta_colecoes';
    ...
    public function fetchAll($sWhere = null, $sOrder = null, $sJoin = null, $nPagina = null, $nResultadoPagina = null) {
        ...
        if ($sJoin) {
            ...
            $sSql->from(array('colecao' => 'coleta_colecoes'));
            foreach ($sJoin as $joinStatement) {
                $sSql->$joinStatement["joinType"]($joinStatement["table"], $joinStatement["onCols"], $joinStatement["colReturn"]);
            }
        }
