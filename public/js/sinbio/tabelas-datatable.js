$().ready(function () {
    ...
    table = $('.tabela').DataTable({
        responsive: true,
        dom: 'rB<"container-pes-bas"><"container-pes-avan">tip',
        buttons: [
            {
                text: 'Novo',
                action: function () {
...
function criarPesqAvan() {
    ...
    $('.tabela th').each(function () {
        ...
        var column = $(this);
        var htmlFiltro = '<input id="filtro-comp' + column.index() + '" class="filtro-composto" type="text" placeholder="Procurar em ' + column.text() + '"/>';
